# Global Payments Reporting API - .NET
...
Create a `.env` file in the dotnet directory:
...
All endpoints use `/api/reports/{action}` and support both GET and POST requests.
...
- `status` - Transaction status (e.g., APPROVED, DECLINED)
...
```bash
curl "http://localhost:8000/api/reports/detail/TRN_123456"
```

**Required**: Transaction ID in URL path
...
```bash
curl "http://localhost:8000/api/reports/settlement?start_date=2025-09-01&end_date=2025-09-30"
```
...
**CSV Export**:
```bash
curl "http://localhost:8000/api/reports/export?format=csv&start_date=2025-09-01&end_date=2025-09-30" -o transactions.csv
```

**XML Export**:
```bash
curl "http://localhost:8000/api/reports/export?format=xml&start_date=2025-09-01&end_date=2025-09-30" -o transactions.xml
```

**JSON Export**:
```bash
curl "http://localhost:8000/api/reports/export?format=json&start_date=2025-09-01&end_date=2025-09-30"
```
...
```bash
curl "http://localhost:8000/api/reports/disputes?start_date=2025-09-01&end_date=2025-09-30"
```
...
**Get Dispute Details**:
```bash
curl "http://localhost:8000/api/reports/disputes/DIS_123456"
```
...
```bash
curl "http://localhost:8000/api/reports/deposits?start_date=2025-09-01&end_date=2025-09-30"
```
...
**Get Deposit Details**:
```bash
curl "http://localhost:8000/api/reports/deposits/DEP_123456"
```
...
```bash
curl "http://localhost:8000/api/reports/declines?start_date=2025-09-01&end_date=2025-09-30"
```
...
```bash
curl "http://localhost:8000/api/reports/date-range?start_date=2025-09-01&end_date=2025-09-30&transaction_limit=100"
```
...
```bash
curl "http://localhost:8000/api/reports/batches?start_date=2025-09-01&end_date=2025-09-30"
```
...
```bash
curl "http://localhost:8000/api/reports/summary?start_date=2025-09-30&end_date=2025-09-30"
```

### Find Specific Transaction

```bash
curl "http://localhost:8000/api/reports/search?transaction_id=TRN_abc123"
```

### Export Monthly Transactions

```bash
curl "http://localhost:8000/api/reports/export?format=csv&start_date=2025-09-01&end_date=2025-09-30" -o september_transactions.csv
```
...
```bash
curl "http://localhost:8000/api/reports/settlement?start_date=2025-09-30"
```
